...
APP/PROJECT UPDATE
- Apps & Projects are stored in the Supabase public.apps table, not browser localStorage.
- Name, category, description, app/project URL, website URL, download URL and logo are supported.
- The public website reads the apps from Supabase, so saved items can appear across browsers/devices.
- App/project logo display is intentionally compact (58x58) on the public cards.
